...
public class XinlijiankangCollectionView extends XinlijiankangCollectionEntity implements Serializable {
	...
	*/
	...
	//级联表 心理健康
		...
		*/
		...
		private Integer xinlijiankangZhixunshiId;
		/**
		* 心理健康标题
		*/
	...
	*/
	...
	//级联表的get和set 心理健康
		...
		* 获取：心理健康 的 咨询师
		*/
		public Integer getXinlijiankangZhixunshiId() {
			return xinlijiankangZhixunshiId;
		}
		/**
		* 设置：心理健康 的 咨询师
		*/
		public void setXinlijiankangZhixunshiId(Integer xinlijiankangZhixunshiId) {
			this.xinlijiankangZhixunshiId = xinlijiankangZhixunshiId;
		}
